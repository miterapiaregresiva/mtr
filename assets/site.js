document.addEventListener('DOMContentLoaded', function () {
  ...
  /* Shared, indexable brand lockup across all page headers. */
  document.querySelectorAll('.site-header .brand').forEach(function (brand) {
    brand.classList.add('brand-lockup');
    brand.setAttribute('aria-label', 'Mi Terapia Regresiva, inicio');
    brand.innerHTML = '<img src="assets/images/branding/miterapiaregresiva-symbol.svg" alt="" width="88" height="88"><span class="brand-copy"><span class="brand-domain"><strong>miterapiaregresiva</strong><span>.com</span></span><span class="brand-tagline">Explora tu historia. Comprende tu presente.</span><span class="brand-rule" aria-hidden="true"><span></span><b>•</b><span></span></span><span class="brand-service">Terapia regresiva en Tenerife</span></span>';
  });
